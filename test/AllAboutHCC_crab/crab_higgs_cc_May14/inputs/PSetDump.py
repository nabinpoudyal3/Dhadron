...
process.ak1GenJetsNoNu = cms.EDProducer("FastjetJetProducer",
...
process.ak1PFJetsCHS = cms.EDProducer("FastjetJetProducer",
...
process.ak1PFJetsCHSConstituents = cms.EDProducer("MiniAODJetConstituentSelector",
    cut = cms.string(''),
    src = cms.InputTag("ak1PFJetsCHS")
)


process.patJetCorrFactorsAK1PFCHS = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
...
process.patJetFlavourAssociationAK1PFCHS = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartons","bHadrons"),
    cHadrons = cms.InputTag("patJetPartons","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak1PFJetsCHS"),
...
process.patJetFlavourAssociationLegacyAK1PFCHS = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAK1PFCHS")
)


process.patJetGenJetMatchAK1PFCHS = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak1GenJetsNoNu"),
...
process.patJetPartonAssociationLegacyAK1PFCHS = cms.EDProducer("JetPartonMatcher",
...
process.patJetPartonMatchAK1PFCHS = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
...
process.patJetsAK1PFCHS = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAK1PFCHS"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAK1PFCHS"),
    ...
    genJetMatch = cms.InputTag("patJetGenJetMatchAK1PFCHS"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAK1PFCHS"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAK1PFCHS")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("ak1PFJetsCHS"),
...
process.selectedPatJetsAK1PFCHS = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("patJetsAK1PFCHS")
)
...
process.noOutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = cms.untracked.vstring('keep *_selectedPatJetsAK1PFCHS_*_*', 
        'drop *_selectedPatJetsAK1PFCHS_calo*_*', 
        'drop *_selectedPatJetsAK1PFCHS_tagInfos_*')
)
...
process.patAlgosToolsTask = cms.Task(process.ak1GenJetsNoNu, process.ak1PFJetsCHS, process.ak1PFJetsCHSConstituents, process.chs, process.packedGenParticlesForJetsNoNu, process.patJetCorrFactorsAK1PFCHS, process.patJetFlavourAssociationAK1PFCHS, process.patJetFlavourAssociationLegacyAK1PFCHS, process.patJetGenJetMatchAK1PFCHS, process.patJetPartonAssociationLegacyAK1PFCHS, process.patJetPartonMatchAK1PFCHS, process.patJetPartons, process.patJetPartonsLegacy, process.patJetsAK1PFCHS, process.selectedPatJetsAK1PFCHS)


process.ak1JetSubs = cms.Sequence(process.packedGenParticlesForJetsNoNu+process.ak1GenJetsNoNu+process.chs+process.ak1PFJetsCHS+process.ak1PFJetsCHSConstituents)
